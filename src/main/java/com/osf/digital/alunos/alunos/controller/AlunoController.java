...
public class AlunoController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<AlunoDTO> create(@RequestBody @Valid AlunoForm form, UriComponentsBuilder uriBuilder) {
    ...
    @PutMapping("/{id}")
    @Transactional
    public ResponseEntity<AlunoDTO> update(@PathVariable Long id, @RequestBody @Valid AlunoForm form) {
        Optional<Aluno> optional = alunoService.findById(id);
        if (optional.isPresent()) {
